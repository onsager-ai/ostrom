...
pub use check::{
    ...
    CheckEvaluation, CheckFault, CheckReceipt, CheckState, CheckVerdict, DefinitionDigest,
...
pub use policy::{
    ...
    PassResolutionError, PromptValue, ResolvedInput, ResolvedLoop, ResolvedLoopCeilings, RuleDecl,
    RuleDefaults,
    RunSignatureDecl,
