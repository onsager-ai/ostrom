...
pub const EMBEDDED_ASSETS: &[EmbeddedAsset] = &[
    ...
    EmbeddedAsset {
        ...
        sha256: "0e288fe35e21a028f3726672a05105b657e63c76dd7cdf20a46b49ea9055f3c8",
    },
    EmbeddedAsset {
        path: "skills/merge/SKILL.md",
        contents: include_str!("../../../plugins/ostrom/skills/merge/SKILL.md"),
        sha256: "704758bf6ba419236de2b1c46f06f609bd3d9fca24aa5116cea8d8a6a222d570",
    },
    EmbeddedAsset {
...
pub fn resolve_harness_root() -> PathBuf {
    ...
    resolve_harness_root_from(
        environment::CLAUDE_CONFIG_DIR.value_os(),
        environment::HOME.value_os(),
        &cwd,
    )
}
