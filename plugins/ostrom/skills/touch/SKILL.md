...
description: Log a human intervention to the configured touch log — a
  local file by default, or Notion. Use whenever the user types /ostrom:touch,
...
1. shipped defaults — `config/touch-defaults.yaml` in this plugin (sibling of `skills/`)
